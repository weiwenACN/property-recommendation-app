...
export function AgentContactButtons({ onCall, onEmail, onWhatsApp, onMessage }: AgentContactButtonsProps) {
  ...
  return (
    <div className="grid grid-cols-4 gap-2">
      ...
      <button onClick={onWhatsApp} className={`${btnBase} bg-[#25D366] text-white hover:bg-[#1fb85a]`}>
        <WhatsAppIcon />
        <span>WhatsApp</span>
      </button>
